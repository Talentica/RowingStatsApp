...
import static com.talentica.rowingapp.common.data.DataRecord.Type.STROKE_POWER_END;
 ...
 *
 */
public class StrokePowerBarGraphView extends View implements DataUpdatable, AppConstants {
	 ...
	 * @param roboStroke
	 */
	public StrokePowerBarGraphView(Context context, AppStroke roboStroke) {
		super(context); 
