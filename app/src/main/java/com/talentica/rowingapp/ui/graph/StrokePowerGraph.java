...
import com.talentica.rowingapp.common.NumberHelper;
...
import static com.talentica.rowingapp.common.data.DataRecord.Type.STROKE_RATE;
...
public class StrokePowerGraph extends LineGraph implements DataUpdatable {
	...
	public StrokePowerGraph(UILiaison uiLiaison, AppStroke roboStroke) {
		super(uiLiaison, INITIAL_XRANGE, XYSeries.XMode.FIXED, Y_RANGE, INCR);
		
		this.roboStroke = roboStroke;
		
		powerSeries = multySeries.addSeries(new CyclicArrayXYSeries(XYSeries.XMode.FIXED, new XYSeries.Renderer(uiLiaison.createPaint())));
