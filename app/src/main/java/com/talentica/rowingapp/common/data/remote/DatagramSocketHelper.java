	...
	private void joinMulticastGroup(MulticastSocket s) throws IOException {
...

		{
			...
			while (enumeration.hasMoreElements()) {
				...
				Log.d("joinMulticastGroup", "interface {}:  lo={}, ppp={}, up={}, virt={}, multicast={} - {}");
//						, new Object[]{i.getDisplayName(), i.isLoopback(), i.isPointToPoint(), i.isUp(), i.isVirtual(), i.supportsMulticast(), i});

				if (i.isUp() && !i.isLoopback() && !i.isPointToPoint() && i.supportsMulticast()) {
					Log.i("joinMulticastGroup", "using interface ="+ i);
					ifc = i;
					break;
				}
			}
		...
		Log.i("joinMulticastGroup","client join multicast address ="+ socketAddress);
