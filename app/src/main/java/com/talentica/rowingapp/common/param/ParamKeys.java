...
package com.talentica.rowingapp.common.param;
...
public enum ParamKeys implements ParameterInfo {
    PARAM_GPS_SPEED_CHANGE_DAMPER("com.talentica.rowing.gps.speedChangeDamper",
            "Speed change damper",
    ...
    PARAM_GPS_MIN_DISTANCE("com.talentica.rowing.gps.minDistance",
            "min distance",
            "Minimum distance boat must travel between each distance/speed calculation",
            "GPS",
            ParameterLevel.ADVANCED, 5) {
        @Override
    ...
    PARAM_GPS_DATA_FILTER_MAX_SPEED("com.talentica.rowing.gps.maxSpeed",
            "max speed",
            "Maximum permited boat speed - useful for catching and throwing away erratic GPS readings",
            "GPS",
            ParameterLevel.ADVANCED, 6.5f),

    PARAM_SENSOR_ORIENTATION_CHANGE_DAMP_FACTOR("com.talentica.rowing.sensor.orientationDampFactor",
            "orientation damper",
            "Lowpass filter used as stabalizer for the 'down' notion of the application",
            "Sensors",
            ParameterLevel.ADVANCED, 0.01f),

    PARAM_SENSOR_ORIENTATION_LANDSCAPE("com.talentica.rowing.sensor.orientationLandscape",
            "session recording on", "", "{internal}", ParameterLevel.PRIVATE, false),

    PARAM_SENSOR_ORIENTATION_REVERSED("com.talentica.rowing.sensor.reverseDeviceOrientation",
            "coax mode",
    ...
    PARAM_STROKE_RATE_AMPLITUDE_FILTER_FACTOR("com.talentica.rowing.stroke.rate.amplitudeFilterFactor",
    ...
    PARAM_STROKE_RATE_AMPLITUDE_CHANGE_DAMPER_FACTOR("com.talentica.rowing.stroke.rate.amplitudeChangeDamperFactor",
    ...
    PARAM_STROKE_RATE_MIN_AMPLITUDE("com.talentica.rowing.stroke.rate.minAmplitude",
    ...
    PARAM_STROKE_RATE_AMPLITUDE_CHANGE_ACCEPT_FACTOR("com.talentica.rowing.stroke.rate.amplitudeChangeAcceptFactor",
    ...
    PARAM_STROKE_RATE_RATE_CHANGE_ACCEPT_FACTOR("com.talentica.rowing.stroke.rate.rateChangeAcceptFactor",
    ...
    PARAM_STROKE_POWER_AMPLITUDE_FILTER_FACTOR("com.talentica.rowing.stroke.power.amplitudeFilterFactor",
            "power filter",
            "*FIXME*", // FIXME
            "Stroke Power",
            ParameterLevel.ADVANCED, .5f),

    PARAM_STROKE_POWER_MIN_POWER("com.talentica.rowing.stroke.power.minPower",
            "power filter",
            "Minimum power (sum of acceleration points) required during a rowing cycle in order for it to register",
            "Stroke Power",
            ParameterLevel.ADVANCED, 5f),

    PARAM_ROWING_STOP_TIMEOUT("com.talentica.rowing.stroke.detector.stopTimeout",
            "stop timeout",
            "How many seconds since end of last stroke before finishing a rowing lap when in 'Autorow' mode",
            "Autorow",
            ParameterLevel.BASIC, 5),

    PARAM_ROWING_START_AMPLITUDE_TRESHOLD("com.talentica.rowing.stroke.detector.minAmplitude",
            "min amplitude",
    ...
    PARAM_ROWING_RESTART_WAIT_TIME("com.talentica.rowing.stroke.detector.restartWaitTime",
    ...
    PARAM_ROWING_MODE("com.talentica.rowing.stroke.detector.startMode",
    ...
    PARAM_ROWING_STRAIGHT_LINE_MODE("com.talentica.rowing.stroke.detector.straightLineMode",
    ...
    PARAM_SESSION_RECORDING_ON("com.talentica.rowing.android.sessionRecordingOn",
            "session recording on", "", "{internal}", ParameterLevel.PRIVATE, false),

    PARAM_SESSION_RECORDING_LEADER_ENABLE("com.talentica.rowing.android.record.leader.enable",
    ...
    PARAM_SESSION_BROADCAST_ON("com.talentica.rowing.session.broadcast.on",
            "session broadcast on",
            "Activate broadcasting Talos sensor data, events to a remote Talos device",
            "Session",
            ParameterLevel.BASIC, false),

    PARAM_SESSION_BROADCAST_PORT("com.talentica.rowing.session.broadcast.port",
    ...
    PARAM_SESSION_BROADCAST_HOST("com.talentica..rowing.android.session.remote.host",
